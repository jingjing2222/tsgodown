...
export const CAPABILITY_MATRIX: Record<CapabilityKey, CapabilityRule> = {
  "route.basic": {
    ...
    backends: {
      go: { status: CapabilityStatus.WIP, strategy: "direct mapping" },
    },
  },
  "handler.async": {
    key: "handler.async",
    ...
    backends: {
      go: { status: CapabilityStatus.TODO, strategy: "goroutine + await shim" },
    },
  },
  "module.esm": {
    key: "module.esm",
    ...
    backends: {
      go: { status: CapabilityStatus.WIP, strategy: "static link graph" },
    },
  },
  "module.cjs": {
    key: "module.cjs",
    ...
    strategy: "cjs bridge",
    backends: {
      go: { status: CapabilityStatus.TODO, strategy: "cjs bridge" },
    },
  },
  "runtime.event_loop": {
    ...
    backends: {
      go: { status: CapabilityStatus.TODO, strategy: "scheduler shim" },
    },
  },
  "node.fs.basic": {
    key: "node.fs.basic",
    ...
    backends: {
      go: { status: CapabilityStatus.TODO, strategy: "os/io adapter" },
    },
  },
  "node.path.basic": {
    key: "node.path.basic",
  ...
  "node.process.env": {
    ...
    backends: {
      go: { status: CapabilityStatus.TODO, strategy: "runtime env map" },
    },
  },
  "node.buffer.basic": {
    ...
    backends: {
      go: { status: CapabilityStatus.TODO, strategy: "[]byte wrapper" },
    },
  },
};
