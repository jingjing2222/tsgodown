...
pub use ir::{
    ...
    HandlerSemanticsIR, ImportBindingIR, ImportIR, JsArrayElementIR, JsClassMethodIR, JsExprIR,
    JsObjectPropIR, JsStmtIR, JsSwitchCaseIR, JsValueIR, ModuleIR, ProgramIR, RouteIR,
};
